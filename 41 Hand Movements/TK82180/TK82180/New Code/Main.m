...
%Testing
flex1inp = input('Enter the signal value for flex1: ');
flex2inp = input('Enter the signal value for flex2: ');
EMGinp = input('Enter the signal value for EMG: ');

%prediction
outp = test(flex1inp,flex2inp,EMGinp)
