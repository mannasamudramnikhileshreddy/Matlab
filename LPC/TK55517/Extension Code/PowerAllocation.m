function powerallocation = PowerAllocation(rhos,q,weights)
%Calculates the power allocation assuming fixed beamforming
...
for j = 1:Kt
    ...
    %achieved by checking when there is equality ; that is, when
...
%Computes the power allocation for a given waterlevel and returns
