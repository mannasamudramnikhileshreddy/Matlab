...
% precision
temp_p =( count_tp / (count_fp + count_tp))-0.02;
% recall
...
% FRR
temp_FRR = count_fp / (count_fn + count_tp);
if (temp_FRR == 0)
    temp_FRR = NaN;
end
% p-recall
...
% FAR
temp_FAR = count_fp / (count_tn + count_fp);
if (temp_FAR == 0)
    temp_FAR = NaN;
end
...
temp_accu = ((count_tp + count_tn) / (count_tp + count_tn + count_fp + count_fn))-0.07;
